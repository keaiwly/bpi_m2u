...
{       
	...
	LCD_OPEN_FUNC(sel, sunxi_lcd_tcon_enable, 150);     //open lcd controller, and delay 100ms 300
...
static struct LCM_setting_table LCM_SL007PC21D0672_setting[] = {//U71B,SUOLING
	{0x25,	  1,  {0x55}},
	{0x80,	  1,  {0x88}},
	{0x81,	  1,  {0x88}},
	{0x82,	  1,  {0x88}},
